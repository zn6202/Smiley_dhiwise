...
import 'models/k3_model.dart'; // ignore_for_file: must_be_immutable
...
class K3Screen extends StatelessWidget {
  ...
  Widget _buildEmailAddress(BuildContext context) {
    return BlocSelector<K3Bloc, K3State, TextEditingController?>(
  ...
  Widget _buildPasswordOne(BuildContext context) {
    return BlocBuilder<K3Bloc, K3State>(
    ...
    return BlocBuilder<K3Bloc, K3State>(
      builder: (context, state) {
        return CustomTextFormField(
          ...
          suffix: InkWell(
            onTap: () {
              context.read<K3Bloc>().add(ChangePasswordVisibilityEvent1(
